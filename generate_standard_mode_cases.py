"""Generate Excel test cases for peak brightness study (标准 mode only).
...
plan_items = [
    ("测试目标", "探究峰值亮度档位、白块亮度、小窗口大小对标准模式峰值亮度的影响规律"),
    ("图像模式", "标准"),
    ("峰值亮度", "高、中、低"),
...
# Save
output = "/home/liaoxiaolan/claudeCodeProject/read410/标准模式峰值亮度测试用例.xlsx"
wb.save(output)
